...
export default class DiscussionTaggedPost extends EventPost {
  ...
  descriptionKey() {
    if (this.props.tagsAdded.length) {
      if (this.props.tagsRemoved.length) {
        return 'tags::forum.post_stream.added_and_removed_tags_text';
      }

      return 'tags::forum.post_stream.added_tags_text';
    }

    return 'tags::forum.post_stream.removed_tags_text';
  }
  ...
  descriptionData() {
    ...
    if (this.props.tagsAdded.length) {
      data.tagsAdded = app.translator.transChoice('tags::forum.post_stream.tags_text', this.props.tagsAdded.length, {
    ...
    if (this.props.tagsRemoved.length) {
      data.tagsRemoved = app.translator.transChoice('tags::forum.post_stream.tags_text', this.props.tagsRemoved.length, {
