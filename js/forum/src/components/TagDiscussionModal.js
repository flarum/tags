...
export default class TagDiscussionModal extends Modal {
  ...
  title() {
    return this.props.discussion
      ? app.translator.trans('tags::choose_tags.edit_title', {title: <em>{this.props.discussion.title()}</em>})
      : app.translator.trans('tags::choose_tags.title');
  }

  getInstruction(primaryCount, secondaryCount) {
    if (primaryCount < this.minPrimary) {
      const remaining = this.minPrimary - primaryCount;
      return app.translator.transChoice('tags::choose_tags.choose_primary_placeholder', remaining, {count: remaining});
    } else if (secondaryCount < this.minSecondary) {
      const remaining = this.minSecondary - secondaryCount;
      return app.translator.transChoice('tags::choose_tags.choose_secondary_placeholder', remaining, {count: remaining});
    }
        ...
        <div className="TagDiscussionModal-form">
          ...
          <div className="TagDiscussionModal-form-submit App-primaryControl">
            {Button.component({
              ...
              icon: 'check',
              children: app.translator.trans('tags::choose_tags.submit_button')
            })}
          </div>
        </div>
      </div>,
