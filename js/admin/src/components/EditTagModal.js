...
export default class EditTagModal extends Modal {
  ...
  title() {
    return this.name()
      ...
      : app.translator.trans('tags::edit_tag.title');
  }
      ...
      <div className="Modal-body">
        <div className="Form">
          <div className="Form-group">
            <label>{app.translator.trans('tags::edit_tag.name_label')}</label>
            <input className="FormControl" placeholder={app.translator.trans('tags::edit_tag.name_placeholder')} value={this.name()} oninput={e => {
          ...
          <div className="Form-group">
            <label>{app.translator.trans('tags::edit_tag.slug_label')}</label>
            <input className="FormControl" value={this.slug()} oninput={m.withAttr('value', this.slug)}/>
          </div>

          <div className="Form-group">
            <label>{app.translator.trans('tags::edit_tag.description_label')}</label>
            <textarea className="FormControl" value={this.description()} oninput={m.withAttr('value', this.description)}/>
          </div>

          <div className="Form-group">
            <label>{app.translator.trans('tags::edit_tag.color_label')}</label>
          ...
          <div className="Form-group">
            <div>
              <label className="checkbox">
                ...
                {app.translator.trans('tags::edit_tag.hide_label')}
              </label>
            </div>
          </div>
          ...
          <div className="Form-group">
            {Button.component({
              ...
              children: app.translator.trans('tags::edit_tag.submit_button')
            })}
            {this.tag.exists ? (
              <button type="button" className="Button EditTagModal-delete" onclick={this.delete.bind(this)}>
                {app.translator.trans('tags::edit_tag.delete_tag_button')}
              </button>
            ) : ''}
          </div>
        </div>
  ...
  delete() {
    if (confirm(app.translator.trans('tags::edit_tag.delete_tag_confirmation'))) {
