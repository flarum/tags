      ...
      <div className="TagsPage">
        <div className="TagsPage-header">
          <div className="container">
            <p>
              {app.translator.trans('tags::tags.about_tags_text')}
            </p>
            {Button.component({
              className: 'Button Button--primary',
              icon: 'plus',
              children: app.translator.trans('tags::tags.create_tag_button'),
              onclick: () => app.modal.show(new EditTagModal())
            })}
            {Button.component({
              className: 'Button',
              children: app.translator.trans('tags::tags.settings_button'),
        ...
        <div className="TagsPage-list">
          <div className="container">
            <div className="TagGroup">
              <label>{app.translator.trans('tags::tags.primary_heading')}</label>
            ...
            <div className="TagGroup">
              <label>{app.translator.trans('tags::tags.secondary_heading')}</label>
