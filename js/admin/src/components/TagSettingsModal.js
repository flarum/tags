...
export default class TagSettingsModal extends SettingsModal {
  ...
  title() {
    return app.translator.trans('tags::tag_settings.title');
  }
  ...
  form() {
    ...
    return [
      <div className="Form-group">
        <label>{app.translator.trans('tags::tag_settings.required_primary_heading')}</label>
        <div className="helpText">
          {app.translator.trans('tags::tag_settings.required_primary_text')}
        </div>
        <div className="TagSettingsModal-rangeInput">
          ...
          {app.translator.trans('tags::tag_settings.range_separator_text')}
          <input className="FormControl"
            type="number"
            min={minPrimaryTags()}
            bidi={maxPrimaryTags} />
      ...
      <div className="Form-group">
        <label>{app.translator.trans('tags::tag_settings.required_secondary_heading')}</label>
        <div className="helpText">
          {app.translator.trans('tags::tag_settings.required_secondary_text')}
        </div>
        <div className="TagSettingsModal-rangeInput">
          <input className="FormControl"
            type="number"
