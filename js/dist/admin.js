...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'startItems', function (items) {
    items.add('allowTagChange', {
      ...
      setting: function setting() {
        ...
        return flarum_components_SettingDropdown__WEBPACK_IMPORTED_MODULE_2___default().component({
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_BasicsPage__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'homePageItems', function (items) {
    items.add('tags', {
      path: '/tags',
...
/* harmony import */ var _common_helpers_tagLabel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/helpers/tagLabel */ "./src/common/helpers/tagLabel.js");
...
/* harmony import */ var _common_utils_sortTags__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/utils/sortTags */ "./src/common/utils/sortTags.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'oninit', function () {
    this.loading = true;
  });
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'oncreate', function () {
    var _this = this;
  ...
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.override)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'view', function (original, vnode) {
    if (this.loading) {
      return m((flarum_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_5___default()), null);
    }

    return original(vnode);
  });
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.override)(app, 'getRequiredPermissions', function (original, permission) {
  ...
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'scopeItems', function (items) {
    (0,_common_utils_sortTags__WEBPACK_IMPORTED_MODULE_8__["default"])(app.store.all('tags')).filter(function (tag) {
      return tag.isRestricted();
    }).forEach(function (tag) {
      return items.add('tag' + tag.id(), {
        label: (0,_common_helpers_tagLabel__WEBPACK_IMPORTED_MODULE_6__["default"])(tag),
        ...
        render: function render(item) {
          if (item.permission === 'viewForum' || item.permission === 'startDiscussion' || item.permission && item.permission.indexOf('discussion.') === 0 && item.tagScoped !== false || item.tagScoped) {
            return flarum_components_PermissionDropdown__WEBPACK_IMPORTED_MODULE_2___default().component({
  ...
  (0,flarum_extend__WEBPACK_IMPORTED_MODULE_0__.extend)((flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'scopeControlItems', function (items) {
    var tags = (0,_common_utils_sortTags__WEBPACK_IMPORTED_MODULE_8__["default"])(app.store.all('tags').filter(function (tag) {
      return !tag.isRestricted();
    }));

    if (tags.length) {
      items.add('tag', m((flarum_components_Dropdown__WEBPACK_IMPORTED_MODULE_3___default()), {
        ...
        }, [(0,_common_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_7__["default"])(tag, {
...
/* harmony import */ var _addTagsHomePageOption__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addTagsHomePageOption */ "./src/admin/addTagsHomePageOption.js");
/* harmony import */ var _addTagChangePermission__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addTagChangePermission */ "./src/admin/addTagChangePermission.js");
...
/* harmony import */ var _components_EditTagModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/EditTagModal */ "./src/admin/components/EditTagModal.js");
/* harmony import */ var _addTagPermission__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addTagPermission */ "./src/admin/addTagPermission.js");
/* harmony import */ var _addTagsPermissionScope__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addTagsPermissionScope */ "./src/admin/addTagsPermissionScope.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Object.assign(_common_compat__WEBPACK_IMPORTED_MODULE_0__["default"], {
  'tags/addTagsHomePageOption': _addTagsHomePageOption__WEBPACK_IMPORTED_MODULE_1__["default"],
  'tags/addTagChangePermission': _addTagChangePermission__WEBPACK_IMPORTED_MODULE_2__["default"],
  'tags/components/TagsPage': _components_TagsPage__WEBPACK_IMPORTED_MODULE_3__["default"],
  'tags/components/EditTagModal': _components_EditTagModal__WEBPACK_IMPORTED_MODULE_4__["default"],
  'tags/addTagPermission': _addTagPermission__WEBPACK_IMPORTED_MODULE_5__["default"],
  'tags/addTagsPermissionScope': _addTagsPermissionScope__WEBPACK_IMPORTED_MODULE_6__["default"]
}));
...
var EditTagModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.name = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.name() || '');
    this.slug = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.slug() || '');
    this.description = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.description() || '');
    this.color = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.color() || '');
    this.icon = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.icon() || '');
    this.isHidden = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.tag.isHidden() || false);
    this.primary = flarum_utils_Stream__WEBPACK_IMPORTED_MODULE_5___default()(this.attrs.primary || false);
  };
  ...
  _proto.title = function title() {
    return this.name() ? (0,_common_helpers_tagLabel__WEBPACK_IMPORTED_MODULE_6__["default"])(app.store.createRecord('tags', {
  ...
  _proto.fields = function fields() {
    ...
    items.add('name', m("div", {
      ...
      oninput: function oninput(e) {
        ...
        _this.slug((0,flarum_utils_string__WEBPACK_IMPORTED_MODULE_4__.slug)(e.target.value));
      }
    })), 50);
  ...
  _proto.onsubmit = function onsubmit(e) {
    ...
    e.preventDefault();
    this.loading = true; // Errors aren't passed to the modal onerror handler here.
...
/* harmony import */ var _EditTagModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./EditTagModal */ "./src/admin/components/EditTagModal.js");
/* harmony import */ var _common_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../common/helpers/tagIcon */ "./src/common/helpers/tagIcon.js");
/* harmony import */ var _common_utils_sortTags__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/utils/sortTags */ "./src/common/utils/sortTags.js");
...
function tagItem(tag) {
  ...
  }, (0,_common_helpers_tagIcon__WEBPACK_IMPORTED_MODULE_7__["default"])(tag), m("span", {
    className: "TagListItem-name"
  }, tag.name()), flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default().component({
    className: 'Button Button--link',
    icon: 'fas fa-pencil-alt',
    onclick: function onclick() {
      return app.modal.show(_EditTagModal__WEBPACK_IMPORTED_MODULE_6__["default"], {
        model: tag
      });
    }
  })), !tag.isChild() && tag.position() !== null ? m("ol", {
    className: "TagListItem-children TagList"
  }, (0,_common_utils_sortTags__WEBPACK_IMPORTED_MODULE_8__["default"])(app.store.all('tags')).filter(function (child) {
    return child.parent() === tag;
  }).map(tagItem)) : '');
}

var TagsPage = /*#__PURE__*/function (_ExtensionPage) {
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(TagsPage, _ExtensionPage);
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    _ExtensionPage.prototype.oninit.call(this, vnode); // A regular redraw won't work here, because sortable has mucked around
  ...
  _proto.content = function content() {
    ...
    return m("div", {
    ...
    }).map(tagItem)), flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default().component({
    ...
    }, app.translator.trans('flarum-tags.admin.tags.create_primary_tag_button'))), m("div", {
    ...
    }, app.translator.trans('flarum-tags.admin.tags.create_secondary_tag_button'))), m("div", {
      className: "Form"
    }, m("label", null, app.translator.trans('flarum-tags.admin.tags.settings_heading')), m("div", {
      className: "Form-group"
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.setMinTags.bind(this, minPrimaryTags, maxPrimaryTags))
      ...
      oninput: flarum_utils_withAttr__WEBPACK_IMPORTED_MODULE_5___default()('value', this.setMinTags.bind(this, minSecondaryTags, maxSecondaryTags))
    }), app.translator.trans('flarum-tags.admin.tag_settings.range_separator_text'), m("input", {
      className: "FormControl",
      type: "number",
  ...
  _proto.onListOnCreate = function onListOnCreate(vnode) {
    var _this2 = this;
  ...
  _proto.onSortUpdate = function onSortUpdate(e) {
    ...
    var order = this.$('.TagList--primary > li').map(function () {
      return {
        id: $(this).data('id'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_models_Tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/models/Tag */ "./src/common/models/Tag.js");
/* harmony import */ var _addTagsPermissionScope__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addTagsPermissionScope */ "./src/admin/addTagsPermissionScope.js");
/* harmony import */ var _addTagPermission__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addTagPermission */ "./src/admin/addTagPermission.js");
...
/* harmony import */ var _components_TagsPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/TagsPage */ "./src/admin/components/TagsPage.js");
/* harmony import */ var _compat__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./compat */ "./src/admin/compat.js");
/* harmony import */ var _flarum_core_admin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @flarum/core/admin */ "@flarum/core/forum");
/* harmony import */ var _flarum_core_admin__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_flarum_core_admin__WEBPACK_IMPORTED_MODULE_7__);
...
app.initializers.add('flarum-tags', function (app) {
  app.store.models.tags = _common_models_Tag__WEBPACK_IMPORTED_MODULE_0__["default"];
  app.extensionData["for"]('flarum-tags').registerPage(_components_TagsPage__WEBPACK_IMPORTED_MODULE_5__["default"]);
  (0,_addTagsPermissionScope__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_addTagPermission__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_addTagsHomePageOption__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_addTagChangePermission__WEBPACK_IMPORTED_MODULE_4__["default"])();
}); // Expose compat API



Object.assign(_flarum_core_admin__WEBPACK_IMPORTED_MODULE_7__.compat, _compat__WEBPACK_IMPORTED_MODULE_6__["default"]);
